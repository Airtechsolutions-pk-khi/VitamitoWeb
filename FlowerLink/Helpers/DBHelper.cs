...
namespace WebAPICode.Helpers
{
    ...
    {
        private static readonly string connectionString = "data source=sql5053.site4now.net;initial catalog=db_a74425_premiumpos;user id=db_a74425_premiumpos_admin;password=PPpp1212#;";
